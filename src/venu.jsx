...
import Conf3 from "./assets/conf3.jpeg"
import Conf4 from "./assets/conf4.jpeg"
            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    ...
                    <div className="flex flex-wrap -m-4">
                        ...
                        {/* Repeat similar blocks for other team members, ensuring all `class` attributes are replaced with `className` */}
                    </div>
                </div>
            </section>
